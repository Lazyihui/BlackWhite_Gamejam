...
public partial class @InputController_Player: IInputActionCollection2, IDisposable
{
    ...
    ~@InputController_Player()
    {
        UnityEngine.Debug.Assert(!m_World.enabled, "This will cause a leak and performance issues, InputController_Player.World.Disable() has not been called.");
    }
